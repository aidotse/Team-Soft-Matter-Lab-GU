...
class Feature:
    ...
    **kwargs
    ...
    def resolve(
        self, image_list: Image or List[Image] = None, **global_kwargs
    ):
        """Creates the image.
...
class Branch(StructuralFeature):
    ...
    def __init__(
        self, feature_1: Feature, feature_2: Feature, *args, **kwargs
    ):
        super().__init__(
            *args, feature_1=feature_1, feature_2=feature_2, **kwargs
        )
